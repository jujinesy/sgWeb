AmCharts.AmPieChart = AmCharts.Class({
        ...
        if (AmCharts.ifArray(e)) {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                var d = AmCharts.toCoordinate,
                    ...
                    w, x, f, s = AmCharts.toNumber(this.labelRadius),
    ...
    checkOverlapping: function (e, g, c, a, h) {
        var d, k, b = this.chartData,
            q = b.length,
            l = g.label;
        if (l) {
            if (!0 === a)
                for (k = e + 1; k < q; k++) b[k].labelQuarter == c && (d = this.checkOverlappingReal(g, b[k], c)) && (k = q);
            else
                for (k = e - 1; 0 <= k; k--) b[k].labelQuarter ==
