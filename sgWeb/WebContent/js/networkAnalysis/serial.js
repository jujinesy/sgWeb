AmCharts.AmSerialChart = AmCharts.Class({
    ...
    countColumns: function () {
        ...
        for (m = 0; m < b; m++) {
            ...
            var l = e.stackType;
            if ("100%" == l || "regular" == l)
                for (g = !1, k = 0; k < c; k++) d = this.graphs[k], d.hidden || d.valueAxis != e || "column" != d.type || (!g && d.stackable &&
                    (a++, g = !0), !d.stackable && d.clustered && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
            if ("none" == l || "3d" == l)
                for (k = 0; k < c; k++) d = this.graphs[k], !d.hidden && d.valueAxis == e && "column" == d.type && d.clustered && (d.columnIndex = a, a++);
            if ("3d" == l) {
        ...
        if (-1 != a.indexOf("[[category]]")) {
            ...
            if (this.categoryAxis.parseDates) {
                var e = this.balloonDateFormat,
                    g = this.chartCursor;
                g && (e = g.categoryBalloonDateFormat); - 1 != a.indexOf("[[category]]") && (e = AmCharts.formatDate(d, e), -1 != e.indexOf("fff") && (e = AmCharts.formatMilliseconds(e, d)), d = e)
            }
...
AmCharts.Cuboid = AmCharts.Class({
    ...
    draw: function () {
        ...
        b = 0 === d ? AmCharts.line(b, [0, c], [0, 0], h, f, l, p) : 0 === c ? AmCharts.line(b, [0,
            0
        ], [0, d], h, f, l, p) : 0 < u ? AmCharts.rect(b, c, d, k, m, l, h, f, u, n, p) : AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], k, m, l, h, f, n, !1, p);
    ...
    draw: function () {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            var r = this.firstDayOfWeek,
                ...
                a = AmCharts.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * h), this.minPeriod, 1, r).getTime(),
                t;
            this.endTime >
                a && (this.endTime = a);
            t = this.minorGridEnabled;
            var v, a = this.gridAlpha,
                z;
            if (this.parseDates && !this.equalSpacing) {
                ...
                if (0 < this.gridCount)
                    for (b = d; b <= k; b++) {
                        ...
                        f = n;
                        if (!isNaN(v))
                            for (h = 1; h < u; h += v) this.gridAlpha = this.minorGridAlpha, t = n + z * h, t = AmCharts.resetDateToMin(new Date(t), e, v, r).getTime(), t = new this.axisItemRenderer(this, (t - this.startTime) * this.stepWidth),
                        this.pushAxisItem(t);
                        this.gridAlpha = a
                    }
            } else if (!this.parseDates) {
                if (this.cellWidth = this.getStepWidth(b), b < k && (k = b), g += this.start, this.stepWidth = this.getStepWidth(b), 0 < k)
                    for (q = Math.floor(b / k), v = this.chooseMinorFrequency(q), h = g, h / 2 == Math.round(h / 2) && h--, 0 > h && (h = 0), k = 0, b = h; b <= this.end + 2; b++) {
                        r = !1;
                        0 <= b && b < this.data.length ? (s = this.data[b], f = s.category, r = s.forceShow) : f = "";
                        if (t && !isNaN(v))
                            if (b / v == Math.round(b / v) || r) b / q == Math.round(b / q) || r || (this.gridAlpha = this.minorGridAlpha, f = void 0);
                            else continue;
                            else if (b /
                ...
                if (this.data[h].time != AmCharts.resetDateToMin(new Date(this.data[h].time), e, u, r).getTime())
                    for (r = 0, A = f, b = h; b < y; b++) n = this.data[b].time, this.checkPeriodChange(e, u, n, A) && (r++, 2 <= r && (p = b, b = y), A = n);
                t && 1 < u && (v = this.chooseMinorFrequency(u), AmCharts.getPeriodDuration(e, v));
                for (b = h; b < y; b++)
                    if (n = this.data[b].time, this.checkPeriodChange(e, u, n, f) && b >= p) {
            ...
            for (b = 0; b < this.data.length; b++)
                if (m = this.data[b]) l = this.parseDates && !this.equalSpacing ? Math.round((m.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - g), m.x[this.id] = l;
