...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function () {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity ==
                ...
                for (d = q; d < u; d += p)
                    if (q = s * d + this.min, q = AmCharts.roundTo(q, this.maxDecCount + 1), !this.integersOnly || Math.round(q) == q)
                        if (isNaN(w) || Number(AmCharts.toFixed(q, w)) == q) {
    ...
    stackGraphs: function (a) {
        ...
        for (k = this.start; k <= this.end; k++)
            for (n = 0; n < h.length; n++) m = h[n], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g) || (c = 100 * (g / f[k]), l.values.percents = c, l.values.total = f[k], "100%" == b && (isNaN(d[k]) && (d[k] = 0), isNaN(e[k]) && (e[k] = 0),
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function () {
        ...
        var S = [],
            ...
            Ka = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g)
            if (this.stackable && "regular" == I || "100%" == I || this.fillToGraph) Ka = !0;
                    ...
                    if (!isNaN(R)) {
                        ...
                        if (!(R < ub && ja < ub || R > vb && ja > vb))
                            if (n) {
                                ...
                                if (L < l && 0 < J && (la = new AmCharts.Cuboid(e, da, J, z - a.d3x, H - a.d3y, wa, Na, O, ka, U, ha, q, n, W, eb), "bottom" != B))
                                    if (B = f.reversed ? "left" : "right", 0 > R) B = f.reversed ? "right" : "left";
                                ...
                                if (K < k + Y * z && 0 < J)
                                    if (la = new AmCharts.Cuboid(e, J, da, z - a.d3x, H - a.d3y, wa, Na, O, ka, this.lineAlpha, ha, q, n, W, eb), 0 > R && "middle" != B) B = "bottom";
            ...
            if (p) {
                ...
                if (c.mouseIsOver || x || z || this.forceShow)
                    if (this.forceShow = !1, z) {
                        ...
                        if (a != this.previousIndex || B != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(),
                                ...
                                for (t = 0; t < H.length; t++)
                                    if (f = H[t], (!this.oneBalloonOnly || f == B) && f.showBalloon && !f.hidden && f.balloonText && (w = p.axes[f.valueAxis.id].graphs[f.id], v = w.y, !isNaN(v))) {
                                        r = w.x;
                                        s = !0;
                                        if (u) {
                                            if (q = v, 0 > r || r > n) s = !1
                        ...
                        b ? (g = {
                                type: "changed"
                            }, g.index = a, g.target = this, g.chart = this.chart, g.zooming = x, g.mostCloseGraph =
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                0 < v || 0 === s ? (0 < r && (a = AmCharts.rect(e, x, t, n, 0, u + 1, I, r, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, x, t, n, this.fillAlpha, u, p, this.borderAlpha, this.cornerRadius), this.showBullet && (ba = AmCharts.circle(e, B, q, this.fillAlpha), f.push(ba))) : (q = [], v = [], "H" != w ? (g = a - A, g > x - s && (g = x - s), g < s && (g = s), q = [0, g - s, a - A, g + s, x, x, 0, 0], v = H ? [0, 0, b - z, 0, 0, t, t, 0] : [t, t, b - z, t, t, 0, 0, t]) : (q = b - z, q > t - s && (q = t - s), q < s && (q = s), v = [0, q - s, b - z, q + s,
                    t, t, 0, 0
                ], q = a < g + (k - g) / 2 ? [0, 0, A < a ? 0 : a - A, 0, 0, x, x, 0] : [x, x, A + x > a ? x : a - A, x, x, 0, 0, x]), 0 < r && (a = AmCharts.polygon(e, q, v, n, 0, u, I, r), a.translate(1, 1), f.push(a)), n = AmCharts.polygon(e, q, v, n, this.fillAlpha, u, p, this.borderAlpha));
                this.bg = n;
                f.push(n);
                n.toFront();
                e = 1 * this.deltaSignX;
...
AmCharts.AmSlicedChart = AmCharts.Class({
    ...
    measureMaxLabel: function () {
        ...
        for (c = 0; c < a.length; c++) {
            var d =
                this.formatString(this.labelText, a[c]),
...
AmCharts.TrendLine = AmCharts.Class({
    ...
    draw: function () {
        ...
        var b = a.chart,
            ...
            t = b.dataDateFormat;
        h && (k && (k instanceof Date || (k = t ? AmCharts.stringToDate(k, t) : new Date(k)), a.initialDate = k, d = h.dateToCoordinate(k)), l && (d = h.categoryToCoordinate(l)), m && (m instanceof Date || (m = t ? AmCharts.stringToDate(m, t) : new Date(m)), a.finalDate = m, e = h.dateToCoordinate(m)), n && (e = h.categoryToCoordinate(n)));
...
AmCharts.handDrawnLine = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    for (m = 1; m < b.length; m++)
        for (var p = [b[m - 1], b[m]], q = [c[m - 1], c[m]], q = AmCharts.makeHD(p, q, a.handDrawScatter), p = q[0], q = q[1], u = 1; u < p.length; u++) n.push(AmCharts.line(a, [p[u - 1], p[u]], [q[u - 1], q[u]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return n
};
