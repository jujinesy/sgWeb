...
$q="select * from USER";                         //test 테이블의 레코드를 모두 뽑아오기
...
<td>NO</td><td>GROUP_ID</td><td>MAC_ADDRESS</td><td>OBTAIN_FLAG</td><td>IP_ADDRESS</td>
    		<td>USER_ID</td><td>USER_PASSWORD</td><td>BLACK_FLAG</td><td>E_MAIL</td><td>SUBNET_MASK</td>
    		<td>GATEWAY</td><td>BASIC_DNS</td><td>SUB_DNS</td><td>EVENT_ID</td><td>ACCEPT</td><td>USER_NICKNAME</td>
</tr>";
...
<td>$dbNO[$i]</td><td>$dbGROUP_ID[$i]</td><td>$dbMAC_ADDRESS[$i]</td><td>$dbOBTAIN_FLAG[$i]</td><td>".long2ip($dbIP_ADDRESS[$i])."</td>
<td>$dbUSER_ID[$i]</td><td>$dbUSER_PASSWORD[$i]</td><td>$dbBLACK_FLAGT[$i]</td><td>$dbE_MAIL[$i]</td><td>$dbSUBNET_MASK[$i]</td>
<td>".long2ip($dbGATEWAY[$i])."</td><td>$dbBASIC_DNS[$i]</td><td>$dbSUB_DNS[$i]</td><td>$dbEVENT_ID[$i]</td><td>$dbACCEPT[$i]</td><td>$dbUSER_NICKNAME[$i]</td>
</tr>
";
};
echo "</table>";
